...
, calendar_id     INTEGER, owner_user_id UUID, visibility      TEXT NOT NULL DEFAULT 'default', location TEXT, location_lat DOUBLE PRECISION, location_lon DOUBLE PRECISION, travel_time_s INTEGER, travel_distance_m INTEGER, travel_provider TEXT, travel_computed_at TEXT, category TEXT, space_id INTEGER);
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    notes         TEXT,
    created_at    TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH24:MI:SS')
, priority INTEGER NOT NULL DEFAULT 1, estimated_minutes INTEGER, created_by_user_id UUID, parent_task_id INTEGER, recurrence_rule TEXT, space_id INTEGER);
...
CREATE TABLE IF NOT EXISTS wa_self_identity (
    -- The phase_e_uuid_bootstrap.py transformer only converted INTEGER
    -- columns to UUID and missed this BIGSERIAL PK. Without this fix
    -- the migration 102 RLS policies fail with 'bigint = uuid' the
    -- moment they try to compare owner_user_id to auth.uid().
...
CREATE TABLE IF NOT EXISTS document_series (
    ...
    owner_user_id UUID,                    -- per-user series; NULL = household-shared
...
CREATE TABLE IF NOT EXISTS agent_conversations (
    id            TEXT PRIMARY KEY,
    user_role     TEXT NOT NULL,
    user_id UUID,                       -- nullable for legacy rows
...
CREATE TABLE IF NOT EXISTS event_attendees (
    ...
    user_id UUID,          -- nullable when person_name is set
...
CREATE TABLE IF NOT EXISTS trusted_kiosk_devices (
    ...
    user_id UUID NOT NULL,    -- admin who trusted it
...
INSERT INTO schema_migrations (version, name) VALUES (0, 'phase_e_init') ON CONFLICT (version) DO NOTHING;
