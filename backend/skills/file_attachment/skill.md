...
when_to_use: |
  ...
  Pass `visibility` only when the user said who may see it (private, business or shared); otherwise their default applies.
...
inputs:
  ...
  visibility:
    type: string
    required: false
    description: private, business or shared.
  title:
    type: string
    required: false
