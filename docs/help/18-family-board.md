...
# Family board — the wall tablet

The tablet on the wall can show more than photos: the week with everyone's appointments in their own colour, and below it a column per person with today's tasks and routines, tap to tick.
